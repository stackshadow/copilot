...
#ifndef coMessageQueue_H
#define coMessageQueue_H
...
class coMessageQueue {

	private:
        lockID              messageFiFoLock;
        coMessage*          messageFiFo[queueLen];
        bool                messageFiFoUsed[queueLen];
        int                 messageFiFoIndexWritten = queueLen - 1;
